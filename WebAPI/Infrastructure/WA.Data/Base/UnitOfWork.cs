...
public abstract class UnitOfWork : object, IUnitOfWork
{
    ...
    public UnitOfWork(Utility.Tools.Options options) : base()
    {
        Options = options;
    }

    // **********
    protected Utility.Tools.Options Options { get; set; }
    // **********
    ...
    internal DatabaseContext DatabaseContext
    {
        get
        {
            if (_databaseContext == null)
            {
                ...
                {
                    case Utility.Tools.Enums.Provider.SqlServer:
                        {
                    ...
                    case Utility.Tools.Enums.Provider.MySql:
                        {
                    ...
                    case Utility.Tools.Enums.Provider.Oracle:
                        {
                    ...
                    case Utility.Tools.Enums.Provider.PostgreSQL:
                        {
                    ...
                    case Utility.Tools.Enums.Provider.InMemory:
                        {
